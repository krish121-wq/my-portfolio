...
<div class="main-content w-100">
    <div class="container-fluid">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-8">
                <h2 class="fw-bold text-dark mb-1">Edit Brands</h2>
                <p class="text-muted mb-0" style="font-size: 0.95rem;">Update existing brands details.</p>
            </div>
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="{{ route('brands.index') }}" class="btn btn-secondary btn-lg shadow-sm rounded-pill px-4">
                ...
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('brands.update', $brand->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="brands" class="form-label fw-bold text-secondary text-uppercase text-xs">Brands</label>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-5">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg shadow rounded-pill px-5" style="background: linear-gradient(45deg, #4e73df, #224abe); border:none;">
                                    <i class="fa-solid fa-check-circle me-2"></i>Update Category
                                </button>
                            </div>
                        </form>
                    </div>
