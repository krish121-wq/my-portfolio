...
<div class="main-content w-100">
    <div class="container-fluid">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-8">
                <h2 class="fw-bold text-dark mb-1">Add New Brands</h2>
                <p class="text-muted mb-0" style="font-size: 0.95rem;">Create a new Brand for your product catalog.</p>
            </div>
                ...
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('brands.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="brand" class="form-label fw-bold text-secondary text-uppercase text-xs">Brand Name</label>
