    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0" style="font-size: 0.95rem;">Update existing category details.</p>
            </div>
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="{{ route('category.index') }}" class="btn btn-secondary btn-lg shadow-sm rounded-pill px-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input 
                                        ...
                                        id="subcategory" 
                                        value="{{ old('subcategory', $category->subcategory) }}"
                                    >
                                </div>
                                @error('subcategory')
                                    <span class="text-danger small ms-3 mt-1 d-block">{{ $message }}</span>
