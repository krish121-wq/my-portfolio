...
<div class="main-content w-100">
    <div class="container-fluid">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-8">
                <h2 class="fw-bold text-dark mb-1">Add New Product</h2>
                <p class="text-muted mb-0" style="font-size: 0.95rem;">Create a new product for your inventory.</p>
            </div>
                        ...
                        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg border-start-0 rounded-end-pill bg-light @error('name') is-invalid @enderror" placeholder="e.g. Nike Air Max" value="{{ old('name') }}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price" class="form-control form-control-lg border-start-0 rounded-end-pill bg-light @error('price') is-invalid @enderror" placeholder="0.00" value="{{ old('price') }}">
                                    </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="mrp" class="form-control form-control-lg border-start-0 rounded-end-pill bg-light @error('mrp') is-invalid @enderror" placeholder="0.00" value="{{ old('mrp') }}">
                                    </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-secondary text-uppercase text-xs">Product Image <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0 rounded-start-pill ps-3">
                                ...
                                <div class="mt-3 ms-3">
                                    <img id="imagePreview" src="#" alt="Preview" class="d-none rounded-3 border shadow-sm" style="height: 100px; width: 100px; object-fit: cover;">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="description" rows="3" class="form-control form-control-lg border-start-0 rounded-end-pill bg-light @error('description') is-invalid @enderror" placeholder="Enter product details...">{{ old('description') }}</textarea>
                                </div>
