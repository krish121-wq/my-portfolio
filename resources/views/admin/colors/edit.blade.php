...
<div class="main-content w-100">
    <div class="container-fluid">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-8">
                <h2 class="fw-bold text-dark mb-1">Edit Color</h2>
                <p class="text-muted mb-0" style="font-size: 0.95rem;">Update existing color details.</p>
            </div>
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="{{ route('colors.index') }}" class="btn btn-secondary btn-lg shadow-sm rounded-pill px-4">
                        ...
                        <form action="{{ route('colors.update', $color->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control rounded-end-pill" value="{{ old('name', $color->name) }}" required>
                                </div>
                                @error('name')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="color" class="form-control form-control-color" value="{{ $color->code }}" title="Choose your color" style="max-width: 60px; padding: 5px;" onchange="document.getElementById('hexCode').value = this.value">
                                    
                                    <input type="text" name="code" id="hexCode" value="{{ old('code', $color->code) }}" class="form-control rounded-end-pill" required>
                                </div>
                                @error('code')
                                    <span class="text-danger small ms-3 mt-1 d-block">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-5">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg shadow rounded-pill px-5" style="background: linear-gradient(45deg, #4e73df, #224abe); border:none;">
                                    <i class="fa-solid fa-check-circle me-2"></i>Update Color
                                </button>
                            </div>
                        </form>
                    </div>
