...
<head>
	...
	<!--
		CSS
		============================================= -->
	<link rel="stylesheet" href="{{ asset('assest/css/linearicons.css');}}">
	<link rel="stylesheet" href="{{ asset('assest/css/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{ asset('assest/css/themify-icons.css')}}">
	<link rel="stylesheet" href="{{ asset('assest/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{ asset('assest/css/owl.carousel.css')}}">
	<link rel="stylesheet" href="{{ asset('assest/css/nice-select.css')}}">
	<link rel="stylesheet" href="{{ asset('assest/css/nouislider.min.css')}}">
	<link rel="stylesheet" href="{{ asset('assest/css/ion.rangeSlider.css')}}" />
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('assest/img/logo.png'); }}" alt=""></a>
